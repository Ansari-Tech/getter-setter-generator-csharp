...
function generateDefault(type, attribute, Attribute) {
	return `
	...
	for (let p of properties) {
		...
		if (create) {
			switch (vscode.window.activeTextEditor.document.languageId) {
				case "csharp":
					generatedCode += generateCsharp(type, attribute, Attribute);
					break;
				default:
					generatedCode += generateDefault(type, attribute, Attribute);
					break;
			}
		}
	}
